    ...
    <div class="container-fluid" style="margin-top:118px;">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="smart_watch.php">Smart Watches</a></li>
                <li class="breadcrumb-item active" aria-current="page">Smart Watch Details</li>
        ...
        <div class="row main_section">
            <div class="col-md-2">
                <div class="row p-5">
                    <img class='slideshow-thumbnails active m-1 img-fluid' src='img/watch_image/smartwatch1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/watch_image/smartwatch1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/watch_image/smartwatch1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/watch_image/smartwatch1.jpg'>
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div id='slideshow-items-container'>
                    <a href="#" data-toggle="modal" data-target=".bd-example-modal-lg">
                        <img class='slideshow-items active img-fluid' src='img/watch_image/smartwatch1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/watch_image/smartwatch1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/watch_image/smartwatch1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/watch_image/smartwatch1.jpg'>
                    </a>
