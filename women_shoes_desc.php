    ...
    <div class="container-fluid" style="margin-top:118px;">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="men_shoes.php">Women Shoes</a></li>
        ...
        <div class="row main_section">
            <div class="col-md-2">
                <div class="row p-5">
                    <img class='slideshow-thumbnails active m-1 img-fluid' src='img/women_shoes/ws1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/women_shoes/ws1.1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/women_shoes/ws1.1.jpg'>
                    <img class='slideshow-thumbnails m-1 img-fluid' src='img/women_shoes/ws1.1.jpg'>
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div id='slideshow-items-container'>
                    <a href="#" data-toggle="modal" data-target=".bd-example-modal-lg">
                        <img class='slideshow-items active img-fluid' src='img/women_shoes/ws1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/women_shoes/ws1.1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/women_shoes/ws1.1.jpg'>
                        <img class='slideshow-items img-fluid' src='img/women_shoes/ws1.1.jpg'>
                    </a>
